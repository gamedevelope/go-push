...
```
go get github.com/gamedevelope/go-push
```
...
![bandwidth](https://github.com/gamedevelope/go-push/blob/master/bandwidth.png?raw=true)

## CPU占用

![cpu usage](https://github.com/gamedevelope/go-push/blob/master/cpu.png?raw=true)
...
![wechat](https://github.com/gamedevelope/go-push/blob/master/E0B82999-82BB-4963-BC2D-FDEAF42230FC.jpeg?raw=true)

知识星球（独家知识）：
![xingqiu](https://github.com/gamedevelope/go-push/blob/master/xingqiu.png?raw=true)